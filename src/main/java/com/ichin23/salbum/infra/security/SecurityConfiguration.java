    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .authorizeHttpRequests( authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/spotify/search").permitAll()
                        .requestMatchers(HttpMethod.GET, "/lastfm/search").permitAll()
                        .requestMatchers(HttpMethod.GET, "/lastfm/searchAlbum").permitAll()
